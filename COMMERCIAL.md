...
- using it inside your institution, however many people run it,
- citing its output in research, policy, an audit, or a disciplinary appeal,
- modifying it for your own internal use,
- redistributing it, or your modified version, under the same AGPL terms.

The one obligation that bites: **if you offer a modified version to others over a network as
a service, you must publish your modifications under the AGPL.** That is deliberate. This
tool's value is that its method is inspectable; a secret fork serving numbers to third
parties would defeat the point.
...
Contact: open a GitHub issue titled "commercial license" and we'll take it from there.
...
how it opens on terms.

## Copyright

Copyright holder: ghxrk13, sole owner of all code in this repository. Dual licensing depends
on single ownership, which is why contributions are not accepted without a signed CLA (see
`CONTRIBUTING.md`).
