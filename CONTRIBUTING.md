...
- **Issues are very welcome.** Bug reports, measured counter-examples, corpus suggestions,
  detector requests, and especially *reproductions with receipts* (attach your `env.json`).
- **Pull requests are not accepted at this time.** If that changes, a CLA will come first,
